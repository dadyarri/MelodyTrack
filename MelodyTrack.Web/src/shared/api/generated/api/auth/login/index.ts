...
// @ts-ignore
import { createApiProblemDetailsFromDiscriminatorValue, createLoginAttemptResponseFromDiscriminatorValue, serializeLoginAttemptResponse, serializeLoginRequest, type ApiProblemDetails, type LoginAttemptResponse, type LoginRequest } from '../../../models/index.js';
// @ts-ignore
...
export interface LoginRequestBuilder extends BaseRequestBuilder<LoginRequestBuilder> {
     ...
     */
     post(body: LoginRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<LoginAttemptResponse | undefined>;
    /**
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export const LoginRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        responseBodyFactory:  createLoginAttemptResponseFromDiscriminatorValue,
