...
/**
 * Instantiates a new {@link MelodyTrackApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createMelodyTrackApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<MelodyTrackApiClient>(requestAdapter, pathParameters, MelodyTrackApiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface MelodyTrackApiClient extends BaseRequestBuilder<MelodyTrackApiClient> {
    /**
     * The api property
     */
 ...
 */
export const MelodyTrackApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const MelodyTrackApiClientNavigationMetadata: Record<Exclude<keyof MelodyTrackApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
