...
4. Backend maintenance — July 2026.
   ...
   - 🟡 Split recurring-task querying, rule evaluation, state transitions, and template rendering out of `RecurringTaskService`. Template rendering, presentation mapping, processed-task querying, and custom-task transitions have been extracted; candidate/rule evaluation and recurring-execution transitions remain.
